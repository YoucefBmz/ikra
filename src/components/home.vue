<template>
    ...
    <div id="home">
        <div class="titles">
            <h1>
                إقرأ <br>
                la plateforme de l’étudiant en commerce
            </h1>
            
            <p>
              Sujets de concours pour les étudiants 2ème année <br>
              (ce premier lancement est un galop d'éssai )
            </p>
        </div>
    </div>
    <div id="about">
    ...
    <div id="contact">
        <div class="contact-container">
          <h1>révisez en un seul click !!!</h1>
          <br>
          <h3>vous pouvez aussi nous suivre sur:</h3>
          <div class="social">
                <a href="https://www.facebook.com/%D8%A5%D9%82%D8%B1%D8%A3-_-ikra-109472674035531/" target="_blank">
                  <img src="images/fb.png" alt="facebook">
                </a>
                <a href="https://www.instagram.com/ikra_edu/?hl=fr" target="_blank">
                  <img src="images/inst.png" alt="istagram">
                </a>
    ...
    <footer>
        <p>
            © - 2020 - <span class="kerini">إقرأ</span> | Tous droits réservés | <br>
...
#home{
    ...
    height: 100vh;
    background: linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)), url(images/studies03.jpeg);
